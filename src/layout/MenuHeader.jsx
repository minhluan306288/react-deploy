  ...
  return (
    <>
      <nav className="bg-gray-800">
          ...
          <div className="relative flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              >
                ...
                {menuOpen
                ? <span dangerouslySetInnerHTML={{__html: iconHamburger}} />
                  ...
                  {routes.filter(i => i.isShowMenu).map(i => 
                        <NavLink
                          ...
                          key={i.path}
                           className={
                            ({ isActive, isPending }) =>
                              `${isPending ? "pending" : isActive ? "bg-gray-900" : "text-gray-300"} transition-all hover:bg-gray-900 hover:text-white  text-white rounded-md px-3 py-2 text-sm font-medium`}
                           to={i.path}
                           >
                           <span>{i.title}</span>
                        </NavLink>
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <div className="relative ml-3">
                ...
                <div
                  style={{display: menuOpenProfile ? 'block' : 'none'}}
        ...
        <div style={{display: menuOpen ? 'block' : 'none'}} className="sm:hidden" id="mobile-menu">
